    ...
    <>
      <div className="h-[95%] ">
        ...
        <div className="reelBox h-[95%] overflow-y-auto scroll-smooth snap-y snap-mandatory">
          {reels.map((reel) => (
            <>
              <div className="h-full relative  snap-start" key={reel.id}>
                <video
                ...
                <div className="overlay w-full h-full text-white flex items-end justify-end top-0  absolute">
                  <div className="w-80 h-16 ">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-pink-700 rounded-full overflow-hidden">
                        <img src={reel.video_pictures[1].picture} className="w-full object-cover h-full" alt="" />
                      </div>
                       <h1>{reel.user.name}</h1>
                       <button className="border-2 border-white/60 px-3 rounded-md text-white font-semibold text-xs py-1">Follow</button>
                    </div>
                  ...
                  <div className="h-80 w-14 text-2xl flex items-center flex-col justify-center gap-7 ">
                    ...
                    <div className="w-6 rounded-md border-4 border-white h-6 ">
